...
<style scoped>
.identity{display:grid;gap:4px}.identity small{display:block;color:var(--muted);font-size:11px}.runtime-table code{font-size:11px;color:var(--muted)}.row-actions{display:flex;align-items:center;gap:4px}.runtime-table{--el-table-header-bg-color:#f6f8fc;--el-table-header-text-color:#667085;--el-table-row-hover-bg-color:#f7faff;--el-table-border-color:#e8edf5;--el-table-expanded-cell-bg-color:#f7f9fd}:deep(.el-table__header-wrapper th.el-table__cell){background:#f6f8fc!important;color:#667085!important;border-bottom:1px solid #e3e9f2;font-size:12px;font-weight:700;letter-spacing:.04em;text-transform:none}:deep(.el-table__body tr:not(.el-table__expanded-cell):hover>td.el-table__cell){background:#f7faff!important}:deep(.el-table__body tr:not(.el-table__expanded-cell)>td.el-table__cell){cursor:pointer}:deep(.el-table__expanded-cell){padding:0!important;background:#f7f9fd!important}:deep(.el-table__expand-icon){color:#667085}
</style>
