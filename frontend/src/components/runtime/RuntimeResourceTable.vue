...
<style scoped>
.identity{display:grid;gap:4px}.identity strong{color:#344054;font-weight:700}.identity small{display:block;color:#667085;font-size:11px}.runtime-table code{font-size:11px;color:#344054}.row-actions{display:flex;justify-content:center}.more-action{width:32px;height:32px;color:#667085}.more-action:hover{background:#eef3fa!important;color:#344054!important}.runtime-table{--el-table-header-bg-color:#f6f8fc;--el-table-header-text-color:#667085;--el-table-row-hover-bg-color:#f7faff;--el-table-border-color:#e8edf5;--el-table-expanded-cell-bg-color:#f7f9fd}.runtime-table :deep(.status-badge){min-height:24px!important;padding:0 8px!important;gap:6px!important;font-size:11px!important}.runtime-table :deep(.status-badge i){width:5px!important;height:5px!important}:deep(.el-table__header-wrapper th.el-table__cell){background:#f6f8fc!important;color:#667085!important;border-bottom:1px solid #e3e9f2;font-size:12px;font-weight:700;letter-spacing:.04em;text-transform:none}:deep(.el-table__body tr:not(.el-table__expanded-cell):hover>td.el-table__cell){background:#f7faff!important}:deep(.el-table__body tr:not(.el-table__expanded-cell)>td.el-table__cell){color:#475467;cursor:pointer}:deep(.el-table__expanded-cell){padding:0!important;background:#f7f9fd!important}:deep(.el-table__expand-icon){color:#667085}:global(.runtime-actions-menu .danger-item){color:#b54708}:global(.runtime-actions-menu .danger-item:hover){background:#fff7ed;color:#9a3412}
</style>
